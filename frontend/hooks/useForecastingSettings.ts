...
const CAMEL_TO_SNAKE: Record<keyof ForecastingSettings, keyof Omit<ForecastingSettingsAPI, "id" | "updated_at">> = {
  ...
  capitalGainsTaxPct: "capital_gains_tax_pct",
  taxableGainPct: "taxable_gain_pct",
  pensionTaxPct: "pension_tax_pct",
...
function apiToSettings(api: ForecastingSettingsAPI): ForecastingSettings {
  return {
    ...
    capitalGainsTaxPct: api.capital_gains_tax_pct,
    taxableGainPct: api.taxable_gain_pct,
    pensionTaxPct: api.pension_tax_pct,
